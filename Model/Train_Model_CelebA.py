"""
Trains a diffusion model for the CelebA-HQ dataset and save trained checkpoints.
"""
...
# ------------------------
def train():
    data_dir = "./celeba_hq_prepared"  # Replace if your dataset saved somewhere else
