...
Prepares the CelebA-HQ dataset for our model by downsizing it to 64x64
"""
...
INPUT_DIR = "/data5/accounts/marsh/.cache/kagglehub/datasets/badasstechie/celebahq-resized-256x256/versions/1/celeba_hq_256" # Replace with your path
# Output directory for processed images
OUTPUT_DIR = "./celeba_hq_prepared" # Replace with your path
